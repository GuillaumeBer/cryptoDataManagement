-- Migration 005: Add long/short ratios table for asset/platform metrics
-- Stores the long/short ratio snapshots grouped by asset, platform, type, and period
...
-- Indexes for fast lookups by asset or platform over time
